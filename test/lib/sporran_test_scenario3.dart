...
main() {
  ...
  group("9. Scenario Tests 1 - ", () {
    ...
    test("3. Create Attachment Offline docid1 Attachment 1", () {
      ...
      sporran9.putAttachment("8docid1", attachment)..then((res) {
            wrapper(res);
          });
    ...
    test("5. Create Attachment Offline docid2 Attachment 1", () {
      ...
      attachment.contentType = 'image/png';
      attachment.payload = attachmentPayload;
      sporran9.putAttachment("8docid2", attachment)..then((res) {
            wrapper(res);
          });
    ...
    test("6. Delete Document Offline docid3", () {
      ...
      sporran9.delete("8docid3", docid3rev)..then((res) {
            wrapper(res);
          });
    ...
    test("7. Check - Get All Docs Offline - Existing Sporran", () {
      ...
      sporran9.getAllDocs(includeDocs: true, keys: keys)..then((res) {
            wrapper(res);
          });
    ...
    test("8. Check - Get All Docs Offline -  New Sporran", () {
      ...
      var wrapper = expectAsync0(() {
        ...
        List<String> keys = null;
        sporran10.getAllDocs(includeDocs: true, keys: keys)..then((res) {
              wrapper1(res);
            });
